      ...
      screen: (
        <div className="bg-gray-800 rounded-lg p-3 text-xs space-y-2">
          ...
          <div className="flex gap-1.5">
            ...
            <div className="w-7 h-7 rounded-full border-2 border-dashed border-gray-700 text-gray-500 text-xs flex items-center justify-center">+</div>
          </div>
        </div>
      ),
    },
      ...
      screen: (
        <div className="bg-gray-800 rounded-lg p-3 text-xs space-y-2">
          ...
          <div className="border border-yellow-600 rounded overflow-hidden">
            <div className="bg-gray-700 px-2 py-1.5 border-b border-gray-700/50">
            ...
            <div className="flex items-center gap-1 px-1.5 py-1 bg-yellow-950/60 border-t border-gray-700/50">
      ...
      <form onSubmit={(e) => { e.preventDefault(); add(); }} className="space-y-2 mb-4">
        <div className="flex gap-2">
          <input
            ...
            className="flex-1 bg-gray-700 border border-gray-700 rounded-lg px-3 py-2 text-sm text-white placeholder:text-gray-500 outline-none focus:border-blue-500"
          />
          <input
            value={reading}
          ...
          <div className="px-4 pb-4 space-y-4 border-t border-gray-700">
            <div className="pt-3">
              <input
                ...
                className="w-full bg-gray-600 border border-gray-700 rounded-lg px-3 py-2 text-sm text-white placeholder:text-gray-500 outline-none focus:border-blue-500"
              />
            </div>
            <div className="space-y-1">
              ...
              <input
                ...
                className="w-full bg-gray-600 border border-gray-700 rounded-lg px-3 py-2 text-sm text-white outline-none focus:border-blue-500"
              />
            </div>
            <div className="space-y-2">
              ...
              <div className="grid grid-cols-2 gap-2 pt-1">
                {Array.from({ length: courtCount }, (_, i) => (
                  <input
                    ...
                    className="bg-gray-600 border border-gray-700 rounded px-2 py-1.5 text-sm text-white placeholder:text-gray-500 outline-none focus:border-blue-500"
                  />
                ))}
              </div>
            </div>
  ...
  return (
    <div className="bg-gray-700 rounded-xl p-5 space-y-4">
      ...
      <textarea
        ...
        rows={4}
        className="w-full bg-gray-800 border border-gray-700 rounded-lg px-3 py-2.5 text-sm text-white placeholder:text-gray-500 outline-none focus:border-blue-500 resize-none font-mono leading-relaxed"
      />

      {/* プレビュー */}
      <div className="space-y-1.5">
        <p className="text-xs text-gray-500">プレビュー（サンプル値で展開）</p>
        <div className="bg-gray-800 border border-gray-700 rounded-lg px-3 py-2.5 text-sm text-gray-200 leading-relaxed min-h-[3rem]">
