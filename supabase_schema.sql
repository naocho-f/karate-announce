...
create table timer_presets (
  ...
  extension_timer_direction text default 'countdown'::text,
  extension_show_timer boolean default true,
  extension_max_count integer default 0,
  ...
  newaza_stops_main boolean default false,
  ...
  buzzer_on_start text default 'off'::text,
  buzzer_sound_start text default 'mid-square-single'::text,
  buzzer_duration_start numeric default 1.5,
  buzzer_repeat_start integer default 1,
  buzzer_on_time_up text default 'auto'::text,
  buzzer_on_newaza text default 'auto'::text,
  buzzer_sound text default 'mid-square-single'::text,
  buzzer_duration numeric default 1.5,
  buzzer_repeat integer default 1,
  buzzer_sound_newaza text default 'mid-square-single'::text,
  buzzer_duration_newaza numeric default 1.5,
