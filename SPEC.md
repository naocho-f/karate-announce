...
> 最終更新: 2026-04-26（確認メールの entry_details 改善: 備考 (entries.memo) を表示するよう buildBasicLines に追加。fieldLabels のデフォルトを FIELD_POOL から構築し英語キー漏れを防止。ラベル未解決のキーは出力しないよう buildExtraLines を厳格化）
