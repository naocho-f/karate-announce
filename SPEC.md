...
> 最終更新: 2026-04-29（admin/court/timer/公開フォームの supabase クエリで `.is("deleted_at", null)` フィルター漏れを全域修正。ホーム「次の試合」「要対応」、court 画面、タイマー、公開フォーム、admin entry 詳細で削除済みデータが表示されていたバグ修正）
