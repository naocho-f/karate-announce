...
> 最終更新: 2026-04-26（エントリーフォーム生年月日入力欄の iPhone 幅対応: input/AgeDisplay に min-w-0 + truncate、input に block + appearance-none を追加。.entry-form スコープでネイティブのカレンダーアイコンを非表示に (input 自体のタップでカレンダーは開く)）
