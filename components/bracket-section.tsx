...
function balanceColor(balance: string, isReference: boolean): string {
  if (isReference) return "text-gray-500 font-bold";
  if (balance === "◎") return "text-green-400 font-bold";
  if (balance === "△") return "text-yellow-400 font-bold";
  return "text-gray-500 font-bold";
}

function SuggestionAxisGroup({ axis, items }: { axis: string; items: SplitSuggestion[] }) {
